...
<div id="ztzfyb_contOne" class="ztzfyb_contOne">
    <div class="ztzfyb_oneleft">
        <div class="oneleftp1"><h3>今日要闻</h3><span>Today's focus</span><a href="#" title="更多今日要闻">更多</a></div>
    ...
    <div class="ztzfyb_onemiddle">
        <h3>发友会视频</h3>
        <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_03.jpg" width="211" height="200" alt="#" /></a>
        <p class="onemiddlep1"><b>时间：</b> <a>2015年3月8日</a></p>
        <p class="onemiddlep2"><b>概要：</b> <a href="#" title="#">2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬</a></p>
        <p class="onemiddlep3"><b>内容：</b> <a href="#" title="#">2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬2茜柘城柘城阿斯蒂芬</a></p>
        <p class="onemiddlep4"><b><a href="#" title="#">查看更多>>></a></p>
    </div>
    <div class="ztzfyb_oneright">
        <h3>手术视频</h3>
        <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_05.jpg" width="300" height="200" alt="#" /></a>
        <span><a href="#" title="#"> 2015年3月8日某某手术视频 >>></a></span>
        <p class="rightp1"><a href="#" title="#">
            您对植发了解吗？植发手术是不是很恐怖？疼吗？很多人对植发手术并不了解，总觉得手术室是一个神秘的地方，只有医生、……
            您对植发了解吗？植发手术是不是很恐怖？疼吗？很多人对植发手术并不了解，总觉得手术室是一个神秘的地方，只有医生、……
        </a></p>
    </div>
...
<div id="ztzfyb_contTwo" class="ztzfyb_contTwo">
    <div class="ztzfyb_twoNav">
        <div class="twoNavleft">
            <h3>发友案例</h3>
            <p>Case base <a href="#" title="更多">更多</a></p>
        </div>
        ...
        <a href="#" title="更多"><img src="/statics/images/zhifa_cn_images/wwfff_03.jpg" width="13" height="13" class="twoNavaimg" alt="更多" /></a>
    </div>
    <div class="ztzfyb_twoDiv" style="display:block;">
        <div class="twoDiv_top">
            ...
            <p class="twodivtopp3">
                <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_20.jpg" width="149" height="94" alt="#" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_23.jpg" width="96" height="83" alt="更多案例" /></a>
            </p>
        </div>
        <div class="twoDiv_bottom">
            <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_30.jpg" width="216" height="126" alt="经典案例" class="twoDivbottomimg" /></a>
            ...
            <ul>
                <li><a href="#" title="#">▪ 万先生植发全过程内容分享万先生植发全过程</a></li>
                <li><a href="#" title="#">▪ 万先生植发全过程内容分享万先生植发全过程</a></li>
                <li><a href="#" title="#">▪ 万先生植发全过程内容分享万先生植发全过程</a></li>
                <li><a href="#" title="#">▪ 万先生植发全过程内容分享万先生植发全过程</a></li>
            </ul>
            <a href="#" title="更多案例" class="twoDivbottoma">更多案例 >>></a>
        </div>
        <div class="twoDivnav">
...
<div id="ztzfyb_contThree" class="ztzfyb_contThree">
    <div class="contThreeLeft">
        <div class="threeNavleft">
            <h3>植发专家</h3>
            <p>Hair transplant experts  <a href="#" title="更多">更多</a></p>
        </div>
        <div class="contThreeLeftdiv" id="contThreeLeftdiv">
            ...
            <div id="contThreeLeftdiv_huandeng" class="contThreeLeftdiv_huandeng">
                <ul>
                    <li>
                        <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_39.jpg" width="188" height="273" alt="#" class="bspandivaimg" /></a>
                        ...
                        <p class="threeleftullip4">★ FUE-APL1.0无痕植发技术的首创人之一 </p>
                        <p class="threeleftullip5">★ 雍禾留美医师之一 </p>
                        <p class="threeleftullip6">
                            <img src="/statics/images/zhifa_cn_images/ffef_32.jpg" width="47" height="37" alt="擅长项目" />
                            <a href="#" title="#">FUE-APL1.0无痕植发技术的首创人之一FUE-APL1.0无痕植发技术的首创人之一FUE-APL1.0无痕植发技术的首创人之一 </a>
                        </p>
                        <p class="threeleftullip7">专家介绍</p>
                        <p class="threeleftullip8"><a href="#" title="#">
                            雍禾拥有15名主任级植发医师，5名药理学博士，共计20余名专家，整天在雍禾植发技术研究院或雍禾植发毛囊干细胞实验室两处进行科研工作，参与日常植发手术的同时也参与技术研发工作，真正做到理论、临床相结合。
                            在雍禾植发只有具备1000以上成功植发案例后，植发专家及其医护团队，才能被选派到各个分院，以先进技术和丰富经验，为每一位脱发患者种植完美效果。
                        </a></p>
                    </li>
                    <li>
                        <a href="#" title="#"><img src="/statics/images/zhifa_cn_images/gsssg_39.jpg" width="188" height="273" alt="#" class="bspandivaimg" /></a>
                        ...
                        <p class="threeleftullip2">★ 北京雍禾植发医院植发主任222222</p>
                        <p class="threeleftullip3">★ 国内首个植发临床研究实验室骨干研究员</p>
                        <p class="threeleftullip4">★ FUE-APL1.0无痕植发技术的首创人之一 </p>
                        <p class="threeleftullip5">★ 雍禾留美医师之一 </p>
                        <p class="threeleftullip6">
                    ...
                    <li>
                        ...
                        <p class="threeleftullip2">★ 北京雍禾植发医院植发主任3333</p>
                        <p class="threeleftullip3">★ 国内首个植发临床研究实验室骨干研究员</p>
                        <p class="threeleftullip4">★ FUE-APL1.0无痕植发技术的首创人之一 </p>
                        <p class="threeleftullip5">★ 雍禾留美医师之一 </p>
                        <p class="threeleftullip6">
                    ...
                    <li>
                        ...
                        <p class="threeleftullip2">★ 北京雍禾植发医院植发主任44444</p>
                        <p class="threeleftullip3">★ 国内首个植发临床研究实验室骨干研究员</p>
                        <p class="threeleftullip4">★ FUE-APL1.0无痕植发技术的首创人之一 </p>
                        <p class="threeleftullip5">★ 雍禾留美医师之一 </p>
                        <p class="threeleftullip6">
